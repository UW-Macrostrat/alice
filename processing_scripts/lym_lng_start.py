...
sql = "DROP TABLE IF EXISTS plate_length_year_can_lng; CREATE TABLE plate_length_year_can_lng ( year integer, plateid integer, coord numeric, the_length numeric)"
'''
sql_lats = []
